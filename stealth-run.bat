...
mkdir "%APPDATA%\overlayai-v1\temp" 2>nul
mkdir "%APPDATA%\overlayai-v1\cache" 2>nul
mkdir "%APPDATA%\overlayai-v1\screenshots" 2>nul
mkdir "%APPDATA%\overlayai-v1\extra_screenshots" 2>nul
