...
// Register the overlayai protocol
if (process.platform === "darwin") {
  app.setAsDefaultProtocolClient("overlayai")
} else {
  app.setAsDefaultProtocolClient("overlayai", process.execPath, [
...
async function initializeApp() {
  try {
    ...
    const appDataPath = path.join(app.getPath('appData'), 'overlayai-v1')
